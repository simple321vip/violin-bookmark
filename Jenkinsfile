...
""",
  ...
  node(label) {
    ...
    def violin_book_repo = checkout([
      ...
      userRemoteConfigs: [[
        credentialsId: '2448e943-479f-4796-b5a0-fd3bf22a5d30',
        url: 'https://gitee.com/guan-xiangwei/violin-bookmark.git'
        ]]
      ])
    ...
    def imageEndpoint = "violin/violin-bookmark"
      ...
      script{
        wrap([$class: 'BuildUser']) {
          withCredentials([usernamePassword(
            ...
            """
            sh "sed -i -e s/tagUpdateTime:.*/tagUpdateTime:' 'T${localDateTime}/g ./prod/violin-bookmark-deployment-prod.yaml"
            sh "sed -i -e s/violin-bookmark:.*/violin-bookmark:${imageTag}/g ./prod/violin-bookmark-deployment-prod.yaml"
            sh "git add ./prod/violin-bookmark-deployment-prod.yaml"
